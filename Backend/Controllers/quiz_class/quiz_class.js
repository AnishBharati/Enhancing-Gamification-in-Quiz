...
exports.add_quiz_topic = (req, res) => {
    ...
    jwt.verify(token, secretKey, (err, decoded) => {
        ...
        db.query(sqlCheckClasses, (err, data) => {
            ...
            const sqlInsertQuizTopic = "INSERT INTO quiz_classes (quiz_class, teacher_id, students_id) VALUES (?, ?, ?)";
            db.query(sqlInsertQuizTopic, [topic, userId, userId], (insertErr, result) => {
                if (insertErr) {
